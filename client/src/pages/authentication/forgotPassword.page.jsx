                    ...
                    <div className="p-4">
                     <div className="card overflow-hidden mt-2">
                         <div className="text-center bg-primary position-relative">
                             ...
                             <p className="text-white-50 mb-0 fs-14" style={{ textAlign: "center", paddingBottom: "20px"}}>Tell us your email address, and we will get you back on track...</p>
                             </div>
                         </div>
                         <div className="card-body position-relative">
                            <div className="p-4 mt-n5 bg-white card rounded pb-0">
                                <form onSubmit={submit}>
                                    ...
                                    <div className="mt-4">
                                        <button className="btn btn-secondary w-100" type="submit">Send OTP</button>
                                    </div>
                                </form>
                            </div>
                         </div>   

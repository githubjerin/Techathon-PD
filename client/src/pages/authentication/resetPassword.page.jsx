                ...
                <div className="col-md-8 col-lg-6">
                    <div className="p-4">
                         ...
                         <div className="card-body position-relative">
                            <div className="p-4 mt-n5 bg-white card rounded pb-0">
                                <form onSubmit={submit}>
                                    ...
                                    <div className="mt-4">
                                        <button className="btn btn-secondary w-100" type="submit">Reset Password</button>
                                    </div>
                                </form>
                            </div>
                         </div>   
                     ...
                     <div className="mt-5 text-center text-white-50" style={{display: "flex", justifyContent: "center"}}> 
                            <p className="text-white">Have account already ? </p> &nbsp;&nbsp;
                            <p className="fw-bold text-white button" onClick={ signin }> Sign in</p>
                        </div>
                    </div>
                 </div>
            </div>
